...
<script type="text/javascript">
	...
	function goNotice() {
		...
		location.href="<%= request.getContextPath()%>/notice/noticeList.pm";
	}
 	...
 	function func_login(){
		...
		const email = $("input#email").val(); // 입력받은 아이디 
 		...
 		$.ajax({
			  url : "<%= request.getContextPath()%>/loginContinue.pm",
	...
	function goContents() {
		  ...
		  $.ajax({
			  url:"<%= request.getContextPath()%>/loginpw.pm",
			  data:{},
			  type:"POST",
			  dataType:"JSON",
			  success:function(json){
...
<div class="inner">
	<form name="loginFrm">	
		<div style="margin-bottom: 25px;">
			<span class="gradtext">인사 관리 </span>

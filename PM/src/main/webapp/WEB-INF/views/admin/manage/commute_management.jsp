...
let arrDept = [];
    ...
    function totalCommuteList(currentShowPageNo) {
    		...
    		$.ajax({
    			url:"<%= ctxPath %>/admin/selectCommuteList.pm",
    ...
    function makePageBar(currentShowPageNo, arrDept, startdate, enddate) {
    		...
    		$.ajax({
    			url:"<%= ctxPath %>/admin/commuteTotalPage.pm",
    			data:{"startdate": startdate,
  				  "enddate":enddate,
  				  "arrDept":arrDept},
  			dataType:"JSON",
...
<div style="width: 90%; margin : 0 5% 0 5%;">
    <nav class="top-nav border-bottom">
        <div class="category">
            <a href="<%= ctxPath %>/commute/mycommute.pm" class="h4 mr-2 text-secondary font-weight-bold">나의 출퇴근</a>

	...
	$(document).ready(function(){
		...
		$(document).on("click","button.btn_label",function(){
			...
			if(selected =="부서장" || selected == "팀장"){
				...
				$.ajax({
					  url : "<%= ctxPath%>/registCheckManager.pm",
					  data : formValues,    
					  type : "POST",
					  dataType : "JSON",
		...
		$(document).on("click","button#btn_download",function(){
			 ...
			 frm.action = "<%= ctxPath%>/downloadExcelFile.pm"; 
			 frm.submit();
		});
...
<div id="peopleContent">
	<div id="header">
		<div id="header_title">
			<a class="current" href="<%=ctxPath%>/people.pm"><span class="title">구성원</span></a>
	...
	<div class="modal fade" id="modal_excelUpload">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content" style="padding: 5px;">
				...
				<!-- Modal body -->
				<div class="modal-body">
					<form id="excelUploadForm" name="excelUploadForm" enctype="multipart/form-data"  method="post" action= "excelUploadAjax.pm">

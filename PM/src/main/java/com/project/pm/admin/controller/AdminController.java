package com.project.pm.admin.controller;
...
public class AdminController {
	...
	@RequestMapping(value="/admin/commuteManagement.pm")
	public String commuteManagement(HttpServletRequest request) {
		...
		return "manage/commute_management.admin";
	}
	
	
	@ResponseBody
	@RequestMapping(value="/admin/selectCommuteList.pm", produces="text/plain;charset=UTF-8", method = {RequestMethod.GET})
	public String selectCommuteList(HttpServletRequest request, HttpServletResponse response, @RequestParam(name = "arrDept[]", required = false) List<String> arrDept) {
		...
		if(!empno.equals("9999")) { // 관리자가 아닌데 접근했을 경우
			RequestDispatcher dispatcher = request.getRequestDispatcher("/notice/noticeList.pm");
			try {
	...
	@ResponseBody
	@RequestMapping(value="/admin/commuteTotalPage.pm", produces="text/plain;charset=UTF-8", method = {RequestMethod.GET})
	...
	@RequestMapping(value="/admin/payStub.pm")
	public String payStub(HttpServletRequest request) {
		...
		if(empno.equals("9999")) { // 관리자 아이디로 들어왔을때
			...
			return "manage/pay_stub_admin.admin";
		}
		
		else { // 일반사원이 들어왔을 때
			
			
			return "manage/pay_stub.admin";
	...
	@ResponseBody
	@RequestMapping(value="/admin/ajaxPayStub.pm", produces="text/plain;charset=UTF-8", method = {RequestMethod.GET})
	...
	// 퇴직금 페이지
	@RequestMapping(value="/admin/severance_pay.pm")
	public String severance_pay(HttpServletRequest request, HttpServletResponse response) {
		...
		return "manage/severance_pay_admin.admin";
		
	}
	
	
	
	@RequestMapping(value="/admin/payment.pm")
	public String payment(HttpServletRequest request, HttpServletResponse response) {
		...
		return "manage/payment.admin";
	}
	
	@ResponseBody
	@RequestMapping(value="/admin/getPaymentList.pm", produces="text/plain;charset=UTF-8", method = {RequestMethod.GET})
	...
	@ResponseBody
	@RequestMapping(value="/admin/paymentListTotalPage.pm", produces="text/plain;charset=UTF-8", method = {RequestMethod.GET})
	...
	@ResponseBody
	@RequestMapping(value="/admin/checkedPayment.pm", produces="text/plain;charset=UTF-8", method = {RequestMethod.POST})
	public String addAlarm_checkedPayment(Map<String, String> paraMap, HttpServletRequest request, @RequestParam String jsonData) {
		...
		if(n > 0) {
		    ...
		    paraMap.put("url", "/admin/payStub.pm?empno=" );
	...
	// 페이징 처리를 위한 페이지수 구해오기 
		@ResponseBody
		@RequestMapping(value = "/admin/getSeverancePayList.pm", produces = "text/plain;charset=UTF-8")
...
//			System.out.println("확인용 페이징 empList : "+ empListPaging);
		...
		// 페이징 처리를 위한 페이지수 구해오기 
		@ResponseBody
		@RequestMapping(value = "/admin/getTotalPage.pm", produces = "text/plain;charset=UTF-8")
...
//			System.out.println("keyword"+keyword);
		...
		@ResponseBody
		@RequestMapping(value="/admin/severancePayment.pm", produces="text/plain;charset=UTF-8", method = {RequestMethod.POST})
		...
		@ResponseBody
		@RequestMapping(value="/admin/allPayment.pm", produces="text/plain;charset=UTF-8", method = {RequestMethod.POST})

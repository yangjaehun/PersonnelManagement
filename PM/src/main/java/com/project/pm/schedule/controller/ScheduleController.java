package com.project.pm.schedule.controller;
...
public class ScheduleController {
	...
	@RequestMapping(value="/schedule/calendar.pm")
	public String calendar(HttpServletRequest request) {
		
		
		return "manage/calendar.admin";
	}
	
	@ResponseBody
	@RequestMapping(value="/schedule/insertSchedule/searchJoinUserList.pm", produces="text/plain;charset=UTF-8") 
	...
	// 켈린더에 일정을 등록하는 메소드
	@ResponseBody
	@RequestMapping(value="/schedule/insertSchedule.pm", produces="text/plain;charset=UTF-8", method = {RequestMethod.POST})
	public String addAlarm_insertSchedule(Map<String, String> paraMap, HttpServletRequest request, ScheduleVO scvo) {
		...
		if(n > 0) {
		    ...
		    paraMap.put("url2", "calendar.pm" ); // 연결되는 pknum등...  (여러개일때는 ,으로 구분된 str)(대신 받는 사람 수랑 같아야됨)
	...
	// 켈린더에 일정을 수정하는 메소드
	@ResponseBody
	@RequestMapping(value="/schedule/updateSchedule.pm", produces="text/plain;charset=UTF-8", method = {RequestMethod.POST})
	...
	// 캘린더를 삭제하는 메소드
	@ResponseBody
	@RequestMapping(value="/schedule/deleteSchedule.pm", produces="text/plain;charset=UTF-8", method = {RequestMethod.POST})
	...
	// 켈린더를 모두 가져오는 메소드
	@ResponseBody
	@RequestMapping(value="/schedule/selectScheduleList.pm", produces="text/plain;charset=UTF-8")
	...
	// 특정 하나 켈린더를 가져오는 메소드
	@ResponseBody
	@RequestMapping(value="/schedule/selectDetailSchedule.pm", produces="text/plain;charset=UTF-8")
